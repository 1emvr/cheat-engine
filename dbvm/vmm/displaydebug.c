...
unsigned long long    DDFrameBufferSize = 0;
unsigned long long    DDHorizontalResolution = 0;
unsigned long long    DDVerticalResolution = 0;
unsigned long long    DDPixelsPerScanLine= 0;
